...
import WebLibrary.WebLibrary.servises.impl.AppUserDetailsService;
                ...
                .authorizeHttpRequests(
                        authorizeHttpRequests ->
                                authorizeHttpRequests.
                                        ...
                                        requestMatchers("/admin/book/create","/admin/genre/create","/admin/author/create").hasRole(UserRoles.ADMIN.name()).
